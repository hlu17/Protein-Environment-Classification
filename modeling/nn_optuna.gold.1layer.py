...
def train_and_evaluate(
    ...
    nn3 = train_model(
        ...
        n_classes,
        hidden_layer_sizes=[hidden_layer_size1],
        kernel_regularizer=kernel_regularizer,
        bias_regularizer=bias_regularizer,
        activity_regularizer=activity_regularizer,
        dropout=dropout,
...
def objective(trial):
    ...
    return train_and_evaluate(learning_rate, hidden_layer_size1, kernel_regularizer, bias_regularizer, activity_regularizer, dropout)
...
with open("./nn_optuna.gold.1layer.txt", 'w') as fh:
